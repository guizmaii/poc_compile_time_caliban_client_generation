...
object Mutation {
  def makeNewSpecies[A](name: NameInput, color: Color)(innerSelection: SelectionBuilder[Potato, A])(
    implicit encoder0: ArgEncoder[NameInput],
